...
(function () {
    ...
    app.sectionsSTDController = function (vm) {
        ...
        var sectionsList = app.listOfSectionsByUser;
        ...
        var grid = $("#sections-list").kendoGrid({
            ...
            change: function (e) {
                ...
                if (seletedSection.id != "" && (app.selectedSection == null || seletedSection.id != app.selectedSection.id)) {

                    app.selectedSection = seletedSection;
                ...
                app.createSectionList.one("change", function (data) {
                    if (data != undefined && data.items.length > 0)
                        section = {
                            ...
                            rank: sectionsList.data().length + 1,
                            sectionObject: {
                                name: sectionName
                            }
                        };
